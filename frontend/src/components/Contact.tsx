        ...
        <Reveal direction="up" delayMs={250}>
          <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
            <a
              ...
              className="px-8 py-4 rounded-xl bg-white text-black font-semibold text-sm hover:bg-cyan-300 transition-all duration-300 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(56,189,248,0.4)] hover:-translate-y-0.5 inline-flex items-center gap-2.5"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-6 py-4 rounded-xl bg-surface-100 hover:bg-surface-50 text-white font-medium text-sm border border-border-subtle hover:border-white/20 transition-all duration-300 hover:-translate-y-0.5 inline-flex items-center gap-2"
            >
