                    ...
                    <div className="flex items-center gap-4">
                      {project.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="group inline-flex items-center gap-2 text-xs font-mono font-medium text-white hover:text-cyan-300 transition-colors"
                        >
                      ...
                      {project.liveUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="group inline-flex items-center gap-1.5 text-xs font-mono font-medium text-cyan-300 hover:text-cyan-200 transition-colors"
                        >
