...
export const Hero3D = () => {
  ...
  useEffect(() => {
    ...
    // Generate 3D Polyhedron / Icosahedron Vertices
    ...
    const render = () => {
      ...
      // Draw subtle wireframe edges between near vertices
      ctx.lineWidth = 1;
      for (let i = 0; i < projected.length; i++) {
        for (let j = i + 1; j < projected.length; j++) {
          ...
          // Connect adjacent geometric vertices
          if (dist3D < scale * 1.5) {
      ...
      // Draw ambient orbital particles
