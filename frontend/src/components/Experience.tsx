          ...
          <div className="lg:col-span-7">
            ...
            <div className="relative border-l border-white/[0.08] ml-3 pl-8 space-y-12">
              {experiences.map((exp, i) => (
                <div key={exp._id || i} className="relative group">
                  {/* Timeline Node */}
                  <div className="absolute -left-[37px] top-1.5 w-4 h-4 rounded-full bg-[#050507] border-2 border-cyan-400 group-hover:bg-cyan-400 group-hover:scale-110 transition-all" />
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {education.map((edu, i) => (
                  <div key={edu._id || i} className="glass-card p-6 rounded-2xl">
            ...
            <div>
              ...
              <div className="space-y-3">
                {certificates.map((cert, i) => (
                  <div
                    key={cert._id || i}
                    className="glass-card p-4 rounded-xl flex items-center justify-between group hover:border-amber-400/40"
                  >
                    <div>
